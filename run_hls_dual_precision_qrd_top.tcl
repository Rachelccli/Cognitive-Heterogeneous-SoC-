...
# Purpose: Vitis HLS C-synthesis for the HYBRID_LP dual-precision QRD-RLS top-level IP.

open_project -reset hls_prj_dual_precision_qrd_top
set_top dual_precision_qrd_top
add_files HLS/HYBRID/dual_precision_qrd_top.cpp
add_files HLS/HYBRID/dual_precision_qrd_top.h
...
add_files HLS/HYBRID/state_bridge.cpp
add_files HLS/HYBRID/state_bridge.h
