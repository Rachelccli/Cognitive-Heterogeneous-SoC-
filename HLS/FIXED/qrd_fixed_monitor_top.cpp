...
#pragma HLS INTERFACE mode=s_axilite port=return bundle=control
    ...
    hls::stream<fix18_t> diag_fixed_s;
...
#pragma HLS STREAM variable=diag_fixed_s depth=QRD_RLS_N
...
#pragma HLS PIPELINE II=1
    ...
    for (int i = 0; i < QRD_RLS_N; i++) {
#pragma HLS PIPELINE II=1
        diag_float_s.write((float)diag_fixed_s.read());
    }
